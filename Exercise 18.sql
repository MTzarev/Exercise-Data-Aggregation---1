...
-- where `department_id` like (2,5,7) and `hire_date`>'2000-01-01'
-- group by `department_id`

# Exercise Data Aggregation 13
create Table `hpe` as
...
SELECT 
    ...
    (SELECT DISTINCT
        ...
        LIMIT 1 OFFSET 2) AS `third_hight_salary`
FROM
    `employees` AS e1
GROUP BY e1.`department_id`
HAVING `third_hight_salary` IS NOT NULL
ORDER BY `department_id` ASC;

# Exercise Data Aggregation 17
